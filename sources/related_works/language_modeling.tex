...
together and can pool their evidence. This distributed representation sidesteps the
sparsity that defeats raw counting, and cut the perplexity of the best n-gram model
by about a quarter. A decade later, the Transformer replaced

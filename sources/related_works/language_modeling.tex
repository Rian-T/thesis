...
equally likely and shrinks as some symbols become predictable. Shannon also showed
that sampling text from richer statistics makes it look more like English: drawn
independently, letters give gibberish; respect digram and then trigram
frequencies, and recognisable fragments of words appear. The more context a model
uses, the better it captures the language.
...
\citep{shannon_prediction_1951}. An alphabet of 27 symbols, the 26 letters and a
space, could in principle carry $\log_2 27 \approx 4.76$ bits per character. Yet
...
words to vectors and lets similar words share evidence, cutting the perplexity of
the best n-gram model by about a quarter. A decade later, the Transformer replaced

...
The first estimators make the history short. Markov's assumption is that the next
...
that simple arithmetic on them captures regularities of meaning, the textbook case
being that \emph{king} $-$ \emph{man} $+$ \emph{woman} lands near \emph{queen}.

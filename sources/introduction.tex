...
This thesis is about teaching artificial intelligence to read clinical text, when
there is almost no clinical text to teach it with. This opening part sets up the
problem. A first chapter traces how
healthcare AI came to rely on learning from large public collections of text, and
why the clinical setting resists it. The next looks at what today's systems make
newly possible, and the shortage of data they run into. A short final chapter states the

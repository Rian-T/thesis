...
\begin{itemize}
  ...
  \item \emph{biomed-fr-v2}, a ten-billion-token French biomedical corpus, with a study of which quality signals help. Some common filters turn out to degrade performance.
  \item \emph{ModernCamemBERT-bio}, the first French biomedical and clinical long-context model, built with a pretraining method that improves domain adaptation.
  \item \emph{OntoBook}, an approach and a dataset that turn a medical knowledge base into training text and improve French medical coding.
  \item \emph{MC-bio-gliner} and \emph{MC-bio-embed}, two variants of ModernCamemBERT-bio, one that pulls information out of clinical text and one that matches terms to medical codes, both from little labelled data.

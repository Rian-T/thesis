...
\newglossaryentry{fine-tuning}{name={fine-tuning}, description={Adapting a pretrained model to a target task by continuing training, usually with supervised data, so that its general representations are specialised to that task~\citep{devlin-etal-2019-bert}.}, sort={fine-tuning}}

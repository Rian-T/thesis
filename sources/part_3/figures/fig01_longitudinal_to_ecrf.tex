\begin{figure}[t]
  ...
  \begin{tikzpicture}[scale=0.91, transform shape,
    ...
    \node[doc] (d4) at (5.4,1.45) {%
      \textbf{25 avril 2032 · RCP}\\[3pt]
      Après rechute: réintroduire 6 cycles de \textcolor{ThesisPrimaryDark}{\textbf{CHOEP-14}}.
    };

    \draw[line width=0.8pt, draw=ThesisNeutral!65]
      (-6.9,-0.35) -- (6.9,-0.35);
    \foreach \x/\date in {-5.4/12.05.18,-1.8/22.05.18,1.8/05.10.18,5.4/25.04.32} {
      \draw[line width=0.8pt, draw=ThesisNeutral!65]
        (\x,-0.48) -- (\x,-0.22);

...
their time. What is different now is the money. These systems are built and sold
commercially at a scale this field has not seen, and a hospital that installs one is
hard to move off it. The company that arrives first keeps the ward for years, and
that puts the pressure on deploying early, before the evidence is in. The pressure
is the companies' to own, and it is also what makes them the wrong party to measure
the result.

Independent evaluation is what the situation asks for, and it does not exist at the
level these systems have reached. Building it is research's part. Gaining two points
on a knowledge test was an honest exercise while the models stayed in the lab, and it
says little about a system that acts on a patient's record over a long horizon. What
is missing is a science of evaluation. It would need environments realistic enough to
act in, measurements fine enough to catch a behaviour rather than an answer, and
evidence about which of those measurements can be trusted. No company has an interest
in building that. It is left to the people who are paid to find out.

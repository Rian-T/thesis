...
behaves when it acts. What is missing is a \textit{science of evaluation}, with
environments realistic enough to act in, measurements fine enough to catch a
behaviour, and evidence about which of those measurements can be trusted. No company
has a reason to build it. Evaluation has been a collection of separate exercises for
as long as the field has existed. Turning it into a discipline is the work in front
of us.

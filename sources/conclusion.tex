...
what it knows, and it is the one the field is least ready to answer. This chapter
takes a first measurement of it.
...
read it one failure mode at a time; \Cref{app:tabib-details} collects the
per-protocol figures behind it. The first is surface form. Writing a pair with
...
shift will demand of the way these models are evaluated.

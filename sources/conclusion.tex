...
Here we are. A computer that could weigh a patient's signs toward a likely disease
no longer sounds like a strange thing to want, and something close to it is being
installed. Medicine has used automated systems for decades, and that work was done
seriously. What is different is the scale of what stands behind them. Billions are
going into these systems, and a hospital that installs one is hard to move off it,
so arriving first holds the ground for years. Speed is what that rewards, and safety
is not what sets the pace. That is for the firms to answer. What research answers
for is narrower. It decides what a safety claim is measured with, and it has long
accepted a few points on a benchmark. That was an honest measure while the models
stayed in the lab. They are in patients' hands now. We will learn what they do there
either way. Whether we learn it before they are everywhere is still open, and not
for long.

...
agent's role: Nabla is turning its documentation tool into a multi-agent platform
that proposes clinical and administrative steps \citep{nabla_agentique_2025}, Alan
runs a patient-facing health assistant \citep{alan_mo_2024}, and Synapse offers a
sourced conversational agent for clinicians \citep{synapse_medgpt_2025}. Such an
...
apparatus, and not the model alone, decides the number.

...
Where the budget goes is also informative. Training the encoder is the cheap
...
model holds the right medical fact. It is what the whole agent does with that fact

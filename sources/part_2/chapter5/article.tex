...
Do these low-layer changes actually drive the downstream improvement? We answer with the freeze interventions described in \S\ref{sec:freeze}, summarized in \Cref{fig:freeze} and \Cref{tab:freeze}.

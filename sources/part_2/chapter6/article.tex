...
This chapter asks whether that structure can be turned into a training signal for encoders. Medical coding makes the question concrete. French hospitals code more than 30 million stays a year~\citep{atih_pmsi} with the CIM-10, CCAM, and ATC classifications, and accurate coding depends on the relations between codes.

...
This chapter asks whether that structure can be turned into a training signal for encoders. Medical coding makes the question concrete. French hospitals code more than 30 million stays a year with the CIM-10, CCAM, and ATC classifications, and accurate coding depends on the relations between codes.
% TODO(cite): source for the >30M annual French hospital stays figure (PMSI/ATIH); left uncited pending verification

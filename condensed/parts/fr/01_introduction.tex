...
être construit à partir de texte public.
...
\begin{itemize}
  ...
  \item \emph{MC-Bio}, un corpus biomédical français de dix milliards de tokens, et une étude des types de contenu et des signaux de qualité qui aident. Les expériences montrent que certains filtres courants dégradent les performances.
  \item Une méthode de pré-entraînement qui entraîne le modèle sur une autre tâche pendant un temps, puis revient à l'objectif principal, améliorant le modèle sans coût supplémentaire.
  \item \emph{OntoBook}, une façon d'ajouter de la connaissance médicale structurée au pré-entraînement en transformant une base de connaissances médicale en texte d'entraînement.
  \item Des architectures de modèles, MC-bio-gliner et MC-bio-embed, qui repèrent les termes cliniques à partir d'une poignée d'exemples annotés seulement.

...
Les dossiers synthétiques de lymphome partent de cas cliniques issus de
Biomed-Enriched, sélectionnés pour leur qualité et parce qu'ils portent sur le
lymphome. Le corpus construit dans cette thèse fournit ainsi les données qui servent à
évaluer sa tâche finale.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{plots/part_3/output/conclusion_agentic_gradient_fr.pdf}
...
Avec le même modèle et la même note falsifiée, aucune prescription dangereuse n'est
produite lors des vingt essais limités à une seule question. Lorsque le modèle dispose
d'outils et que le patient insiste au fil de plusieurs échanges, il prescrit dans cinq
cas sur vingt. Cet échec n'apparaît donc qu'au cours d'une interaction en plusieurs
étapes et reste invisible dans un jeu d'évaluation fondé sur une question et une
réponse. Fournir la
...
une maladie probable} n'est plus une perspective lointaine, et des systèmes qui s'en
rapprochent font leur entrée dans les hôpitaux. Des systèmes automatisés sont vendus à la
médecine depuis des décennies, et ceux qui les ont construits ont travaillé avec soin
sous les contraintes de leur temps. Ce qui est différent aujourd'hui, c'est l'échelle commerciale.
...
Une évaluation indépendante est ce que la situation nécessite, et elle n'existe pas au
niveau qu'ont atteint ces systèmes. La construire est la part de la recherche.
L'évaluation telle qu'elle est souvent pratiquée mesure surtout ce qu'un modèle sait et
la fréquence à laquelle il répond correctement, ce qui suffisait tant que les modèles
répondaient. Elle n'établit
pas comment il se comporte lorsqu'il agit. Ce qui manque, c'est une discipline : des
environnements assez réalistes pour observer les modèles en situation, des mesures
assez fines pour saisir leur comportement, et des preuves sur la fiabilité de ces
mesures.

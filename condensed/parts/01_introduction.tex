...
reached 91.8\% diagnostic accuracy on 304 patients at Leeds in
1972~\citep{dedombal_1972}. Taken to a multicentre trial across eight centres and
16{,}737 patients, it was no longer scored on its own but as an aid: the doctors'
initial diagnostic accuracy rose from 45.6\% before the system was installed to
65.3\% with it~\citep{adams_1986}. The trial was a success, and what did not travel
was the ambition of 1972: elsewhere the program was placed beside a clinician
rather than in front of one, because its knowledge was a table of frequencies from
a single hospital. A learning system depends on the data
...
specialists judged it acceptable in 65\% of cases, against 42.5\% to 62.5\% for the
five faculty specialists~\citep{mycin_eval_1979}. It passed the benchmark and was never used to treat a

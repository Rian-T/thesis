"""
FrenchMedMCQA performance plot.
Generates: plots/chapter2/french_medmcqa_performance.pdf
"""
import sys, os
...
def main():
    ...
    ax.axhline(y=BASELINE_VALUE, linestyle="--", color=COLORS["baseline"],
    ...
    handles.append(mlines.Line2D([], [], color=COLORS["baseline"],
    ...
    out = os.path.join(os.path.dirname(__file__), "french_medmcqa_performance.pdf")
